...
//                        binding.submitButton.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_gameFragment_to_gameWonFragment))
                        view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWonFragment(numQuestions,questionIndex)) //takes as argument the number of questions answered and the number of questions answered correctly
                    }
                } else {
